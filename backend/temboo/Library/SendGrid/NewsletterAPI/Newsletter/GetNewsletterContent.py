...
class GetNewsletterContentInputSet(InputSet):
        ...
        """
        Set the value of the Name input for this choreography. ((required, string) Enter the name of the newsletter to be retrieved. It must be an existing newsletter.)
        """
