...
class GetListEmailAddressesInputSet(InputSet):
        ...
        """
        Set the value of the Email input for this choreography. ((optional, string) Specify an email address to search for in a recipient list.)
        """
        def set_Email(self, value):
            InputSet._set_input(self, 'Email', value)

        """
        Set the value of the List input for this choreography. ((required, string) Enter the recipient list from which email addresses will be retrieved.  Must be an existing recipient list.)
        """
