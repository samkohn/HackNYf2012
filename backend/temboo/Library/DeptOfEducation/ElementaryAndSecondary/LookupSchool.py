...
class LookupSchoolInputSet(InputSet):
        """
        Set the value of the Keyword input for this choreography. ((optional, string) Used to perform a full text search on the data set. For example, you can search for a school name or a school's unique ID.)
        """
