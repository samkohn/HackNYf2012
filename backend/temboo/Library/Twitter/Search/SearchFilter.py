...
class SearchFilterInputSet(InputSet):
        """
        Set the value of the Filter input for this choreography. ((required, string) A search string to use to filter out unwanted Tweets.)
        """
        ...
        """
        Set the value of the ResultsPerPage input for this choreography. ((required, integer) The number of results to return. Defaults to 20.)
        """
        def set_ResultsPerPage(self, value):
            InputSet._set_input(self, 'ResultsPerPage', value)

        """
        Set the value of the SearchString input for this choreography. ((required, string) A string to use as the search query)
        """
