...
class SearchPeopleInputSet(InputSet):
        ...
        """
        Set the value of the Password input for this choreography. ((required, string) The Highrise account password. Use the value 'X' when specifying an API Key for the Username input.)
        """
