...
class CreateServerXMLInputInputSet(InputSet):
        """
        Set the value of the ServerParameters input for this choreography. ((required, xml) An XML file containing the required parameters for the server creation. See documentation for XML schema.)
        """
        def set_ServerParameters(self, value):
            InputSet._set_input(self, 'ServerParameters', value)

        """
        Set the value of the AccountID input for this choreography. ((required, integer) Enter your RightScale Account ID.)
        """
