...
class CreateServerInputSet(InputSet):
        ...
        """
        Set the value of the AccountID input for this choreography. ((required, integer) Enter a RightScale Account ID.)
        """
        ...
        """
        Set the value of the ServerDeployment input for this choreography. ((required, string) Enter the URL of the deployment that this server wil be added to.)
        """
        def set_ServerDeployment(self, value):
            InputSet._set_input(self, 'ServerDeployment', value)

        """
        Set the value of the ServerNickname input for this choreography. ((required, string) Enter a nickname for the server being created.)
        """
        def set_ServerNickname(self, value):
            InputSet._set_input(self, 'ServerNickname', value)

        """
        Set the value of the ServerTemplate input for this choreography. ((required, string) Enter the URL to a server template.)
        """
